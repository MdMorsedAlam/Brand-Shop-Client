    ...
    <div>
      ...
      <div className="">
        ...
        <div className="flex items-center gap-10">
          ...
          <div className="flex-1">
            <p className="text-md text-[#837777] italic">
          ...
          <div className="hero-content flex-col lg:flex-row-reverse">
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg font-bold">
                ...
                collaborate with us, getting in touch is easy. Our dedicated
                customer support team is here to assist you. You can reach out
                to us via email, phone, or social media, and we'll respond
                promptly. Visit our website for more details or simply drop by
                our physical store to have a face-to-face conversation. We look
                forward to hearing from you and building a lasting connection.
                Your satisfaction and input are integral to our brand's growth
                and success. Contact us today and let's engage in a dialogue.
              </p>
            </div>
